export default function AboutUsVisionMission() {
  return (
    <section
      id="vision-mission"
      className="h-auto sm:h-[310px] md:h-[340px] lg:h-[375px] xl:h-[415px] bg-[#E8E6E6] flex flex-col items-center py-[20px] sm:py-0"
    >
      {/* Container for both Vision and Mission */}
      <div className="flex flex-col sm:flex-row gap-[30px] sm:gap-[40px] md:gap-[52px] lg:gap-[65px] xl:gap-[80px] h-full px-[20px] sm:px-0">
        {/* Vision */}
